...
(function() {
    ...
    const baseItems = [
        ...
        { type: 'section', label: 'Off the pitch',        hint: 'football · the starting XI', href: 'beyond.html', icon: '⚽' },
        { type: 'section', label: 'Life in the Lab gallery', hint: 'photos · bench · conferences · outreach', href: '#gallery', icon: '📷' },
