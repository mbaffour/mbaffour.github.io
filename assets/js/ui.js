...
(function() {
    ...
    const baseItems = [
        ...
        { type: 'section', label: 'Beyond the bench',     hint: 'off the pitch · life in the lab', href: 'beyond.html', icon: '⚽' },
        { type: 'section', label: 'Life in the Lab gallery', hint: 'photos · bench · conferences · outreach', href: 'beyond.html#gallery', icon: '📷' },
